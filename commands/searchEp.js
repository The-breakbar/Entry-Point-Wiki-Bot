...
module.exports = {
	global: true,
	name: "search-ep",
	description: "Search for an Entry Point wiki page",
	options: [{ name: "query", type: ApplicationCommandOptionType.String, description: "Term to search for on the Entry Point wiki", required: true }],
