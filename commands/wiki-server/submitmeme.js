module.exports = {
	...
	async execute(interaction, client) {
		...
		if (/https?:\/\/cdn\.discordapp\.com\/attachments\//.test(url)) {
			...
			await interaction.editReply({ content: `Please submit the meme in the form of a discord url (send the meme in any channel, right-click and "Copy link").` });
		}
	}
};
